...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-itqln5i.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-itqln5i.containers.anotherwebservice.com/
...
```
git clone git@github.com:rdeyar/container-itqln5i.git
cd container-itqln5i
```
...
```
docker attach container-itqln5i
```
